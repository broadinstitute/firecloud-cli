...
def main():
    ...
    parser.add_argument('-u', '--url', dest='firecloudUrl', default='https://api.firecloud.org/api', action='store', help='Firecloud API location. Default is https://api.firecloud.org/api')
